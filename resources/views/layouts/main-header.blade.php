    ...
    <div class="container-fluid">
        ...
        <div class="main-header-right">
                    ...
                    <div class="dropdown nav-itemd-none d-md-flex">
                        ...
                        <a href="#" class="d-flex nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                            ...
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent">
                                ...
                                @if(app()->getLocale() == 'ar')
                                <img src="{{ URL::asset('assets/img/flags/egy_flag.png') }}" alt="img">
                                @else
                        ...
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            <a href="{{ route('languageConverter', 'ar') }}" class="dropdown-item d-flex ">
                            ...
                            <a href="{{ route('languageConverter', 'en') }}" class="dropdown-item d-flex ">
                                <span class="avatar  ml-3 align-self-center bg-transparent">
                                    <img src="{{ URL::asset('assets/img/flags/us_flag.jpg') }}" alt="img">
                                </span>
                                <div class="d-flex">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                {{-- this dropdown for notification --}}
                @can('الاشعارات')
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="menu-header-content bg-primary text-right">
                            ...
                            <div class="d-flex">
                                ...
                                <h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">
                                    {{ __('messages.الاشعارات') }}
                                </h6>

                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                    @if (auth()->user()->unreadNotifications)
                                    <a href="{{route('mark-as-read')}}">{{ __('messages.تعين قراءة الكل') }}</a>
                                    @endif
                                </span>
                            </div>
                        ...
                        <div id="unreadNotifications">
                            ...
                            {{-- Mark the notification as read when displayed --}}
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>{{ __('messages.الحساب')}}</a>
                        <a class="dropdown-item" href=""><i class="bx bx-cog"></i>{{ __('messages.تعديل الحساب') }}</a>
                        <a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>{{ __('messages.صندوق الوارد')}}</a>
                        <a class="dropdown-item" href=""><i class="bx bx-envelope"></i>{{ __('messages.الرسائل') }}</a>
                        <a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i>{{
                            __('messages.الاعدادات')}}</a>

                        <a class="dropdown-item" href="{{ route('logout') }}"
                            onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                            <i class="bx bx-log-out"></i>{{ __('messages.تسجيل خروج') }}</a>
