                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            ...
                            <select class="form-control select2" name="type" required>
                                ...
                                {{-- $type: This is a PHP variable, presumably passed from the controller to the view.
                                In Laravel, you can pass data from the controller to the view using the compact method,
                                with method, or other data-sharing techniques. --}}

                                {{-- If the $type variable is set and not null, display its value. --}}
                                {{-- If the $type variable is not set or is null, display the default value'حدد نوع
                                الفواتير'--}}
...
{{--
This script uses jQuery to control the visibility of certain HTML elements based on the selection
of radio buttons. When the radio button with the ID 'type_div' is selected, it hides the 'invoice_number'
element and shows the 'type', 'start_at', and 'end_at' elements. For other radio button selections,
it does the opposite, showing 'invoice_number' and hiding 'type', 'start_at', and 'end_at' --}}
